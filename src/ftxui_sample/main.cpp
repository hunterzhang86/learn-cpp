...
// configuration step. It creates a namespace called `learn_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", learn_cpp::cmake::project_name, learn_cpp::cmake::project_version) };
